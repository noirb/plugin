...
PerceptionNeuronDeviceManager::PerceptionNeuronDeviceManager(std::string &name, std::string &deviceType, std::string &deviceUniqueID, double scaleRatio)
{
	this->service        = NULL;
...
void PerceptionNeuronDeviceManager::setRootPosition(SimObj *obj, const SigCmn::Vector3 &rootPos)
{
	//Save start position
...
// for ManNiiAvatar
void PerceptionNeuronDeviceManager::setJointQuaternion2ManNii(SimObj *obj, const ManNiiPosture::ManNiiJoint &joint)
{
...
// for ManNiiAvatar
void PerceptionNeuronDeviceManager::setJointQuaternions2ManNii(SimObj *obj, const ManNiiPosture &manNiiPosture, const PerceptionNeuronSensorData &sensorData)
{
	if(sensorData.sensorDataMode==PerceptionNeuronSensorData::SensorDataMode::POSITION)
	{
...
// for ManNiiAvatar
ManNiiPosture PerceptionNeuronDeviceManager::convertSensorData2ManNiiPosture(const PerceptionNeuronSensorData &sensorData)
{
	ManNiiPosture manNiiPosture;

	switch(sensorData.sensorDataMode)
	{
		case PerceptionNeuronSensorData::SensorDataMode::POSITION:
		{
			manNiiPosture = PerceptionNeuronDeviceManager::convertPerceptionNeuronJointPosition2ManNiiPosture(sensorData.jointPositions);
			break;
		}
		case PerceptionNeuronSensorData::SensorDataMode::QUATERNION:
		{
			manNiiPosture = PerceptionNeuronDeviceManager::convertPerceptionNeuronJointOrientations2ManNiiPosture(sensorData.jointOrientations);
			break;
		}
	}
...
// for ManNiiAvatar
ManNiiPosture PerceptionNeuronDeviceManager::convertPerceptionNeuronJointOrientations2ManNiiPosture(const PerceptionNeuronSensorData::PerceptionNeuronJointOrientation* PerceptionNeuronJoints)
{
...
//	Quaternion qSB = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::SpineBase    ].orientation);
	Quaternion qSM = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::SpineMid     ].orientation);
	Quaternion qSS = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::SpineShoulder].orientation);
//	Quaternion qNK = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::Neck         ].orientation);

	Quaternion qRE = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::ElbowRight   ].orientation);
	Quaternion qRW = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::WristRight   ].orientation);
	Quaternion qRH = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::HandRight    ].orientation);
	Quaternion qRK = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::KneeRight    ].orientation);
	Quaternion qRA = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::AnkleRight   ].orientation);

	Quaternion qLE = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::ElbowLeft    ].orientation);
	Quaternion qLW = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::WristLeft    ].orientation);
	Quaternion qLH = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::HandLeft     ].orientation);
	Quaternion qLK = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::KneeLeft     ].orientation);
	Quaternion qLA = Quaternion(PerceptionNeuronJoints[PerceptionNeuronSensorData::PerceptionNeuronJointType::AnkleLeft    ].orientation);
 ...
 */
void PerceptionNeuronDeviceManager::correctSlope(PerceptionNeuronSensorData::PerceptionNeuronJointPosition* jointPositions, const double slopeRadX)
{
 ...
 * for ManNiiAvatar
 *
 * Convert PerceptionNeuron joint position data to ManNiiPosture.
 */
ManNiiPosture PerceptionNeuronDeviceManager::convertPerceptionNeuronJointPosition2ManNiiPosture(const PerceptionNeuronSensorData::PerceptionNeuronJointPosition* positionArray)
{
	ManNiiPosture manNiiPosture = ManNiiPosture();
	...
	try
	{
		...
		spineBase = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::SpineBase].position;
//		torso     = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::SpineMid].position;
		neck      = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::Neck].position;
		head      = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::Head].position;

		lshoul = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::ShoulderLeft].position;
		lelb   = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::ElbowLeft].position;
		lwrist = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::WristLeft].position;
		lhand  = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::HandLeft].position;

		rshoul = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::ShoulderRight].position;
		relb   = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::ElbowRight].position;
		rwrist = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::WristRight].position;
		rhand  = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::HandRight].position;

		lhip   = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::HipLeft].position;
		lknee  = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::KneeLeft].position;
		lankle = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::AnkleLeft].position;
		lfoot  = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::FootLeft].position;

		rhip   = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::HipRight].position;
		rknee  = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::KneeRight].position;
		rankle = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::AnkleRight].position;
		rfoot  = positionArray[PerceptionNeuronSensorData::PerceptionNeuronJointType::FootRight].position;
