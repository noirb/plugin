...
//
//				// Get the sensor data of Oculus Rift DK2 from sensor data map.
//				OculusRiftDK2SensorData sensorData;
//				sensorData.setSensorData(sensorDataMap);
//
//				ManNiiPosture posture = OculusDK2DeviceManager::convertEulerAngle2ManNiiPosture(sensorData.getEulerAngle());
//
//				SimObj *obj = getObj(myname());
