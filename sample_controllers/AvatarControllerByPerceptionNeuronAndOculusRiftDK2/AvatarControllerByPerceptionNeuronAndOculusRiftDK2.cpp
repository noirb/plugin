...
#include "AvatarControllerByPerceptionNeuronAndOculusRiftDK2.h"
...
void AvatarControllerByPerceptionNeuronAndOculusRiftDK2::onInit(InitEvent &evt)
{
...
double AvatarControllerByPerceptionNeuronAndOculusRiftDK2::onAction(ActionEvent &evt)
{
...
void AvatarControllerByPerceptionNeuronAndOculusRiftDK2::onRecvMsg(RecvMsgEvent &evt)
{
	try
	{
...
void AvatarControllerByPerceptionNeuronAndOculusRiftDK2::readIniFileAndInitialize()
{
	try
	{
...
{
	return new AvatarControllerByPerceptionNeuronAndOculusRiftDK2;
}
